...
the use of this software.Don't be like me and grant root access to resukisu then flash it directly to the kernel, or you'll get 'the system has been destroyed' error 
